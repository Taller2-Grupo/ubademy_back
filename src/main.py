...
@app.post("/cursos/examen", response_model=ExamenSchema.ExamenResponse, status_code=201)
...
@app.post("/cursos/examen/publicar/{examen_id}", response_model=ExamenSchema.ExamenResponse)
